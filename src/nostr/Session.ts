...
/**
  * Copy from iris-message. I don't need this.
  */
import localForage from 'localforage'

import type { Event, Filter, Path } from '../lib/nostr-tools'
...
const Session = {
  ...
  onLoggedIn() {
    ...
    setInterval(() => {
      console.log(' truehandled msgs per second', Math.round(Events.handledMsgsPerSecond / 5))
